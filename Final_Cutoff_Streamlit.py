    ...
    with tab1:
        ...
        if st.button("Autodetect"):
            if session_state.files is not None:
                ...
                porosity_options = ['PIGE_QEPP', 'PIGE', 'PHIE_F', 'PHIE', 'PIGE_F','PHIE_Final']
                saturation_options = ['SUWI', 'SW_F', 'SW', 'SUWI_QEPP', 'sw', 'Sw_F','SWE','SWE_Final']
                vcl_options = ['VCL', 'VCL_F', 'VCL_QEPP', 'VCL_GEO_QEPP','VSH','VSH_Final']
